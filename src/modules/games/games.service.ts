...
// import { InGamePlayer } from './interfaces/player-inside.interface';
// import { PlayerProfile } from './interfaces/player.interface';
// import { GameProgress } from './interfaces/game-progress.interface';
...
//     async formatInGamePlayer(player: Player): Promise<InGamePlayer> {
...
//     async formatPlayerProfile(player: Player): Promise<PlayerProfile> {
//         const playerAsUser = await this.usersService.getOrThrow(player.userId)
...
//                 return this.formatPlayerProfile(player)
//             })
//         )
//         return {
//             id: game.id,
...
//     async formatGameProgress(game: Game, players: Player[]): Promise<GameProgress> {
//         const formattedPlayers = await Promise.all(
//             players.map(async (player) => {
//                 return this.formatInGamePlayer(player)
//             })
//         )
//         return {
//             id: game.id,
